...
### Build & setup notes
- `colcon build --packages-select omx_moveit_pick_cpp` is required the first time (or after code changes).
- `source install/setup.bash` is required in each new terminal before running any of the commands below.
